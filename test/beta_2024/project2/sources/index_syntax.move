// This module is a demo on "index syntax"
//# init --edition 2024.alpha

//# publish
module Move2024Demo::m333 {
...
//# run
module Move2024Demo::main {
    use Move2024Demo::m333;

    fun main() {
        let v = vector<u64>[0, 1, 2, 3, 4];
        let ts = vector<bool>[true, false, true, false, true];

        let mut s = m333::make_s(v);
        let mut q = m333::make_q(ts);
